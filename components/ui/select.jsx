...
function SelectItem({
  ...
  return (
    (<SelectPrimitive.Item
      ...
      {...props}>
      <span className="absolute right-2 text-sm flex size-3.5 items-center justify-center">
